...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Follow.deleted_at'
        db.delete_column(u'core_follow', 'deleted_at')

        # Adding field 'Follow.created_at'
        db.add_column(u'core_follow', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Follow.deleted_at'
        db.add_column(u'core_follow', 'deleted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Follow.created_at'
        db.delete_column(u'core_follow', 'created_at')
